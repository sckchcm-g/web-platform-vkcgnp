...
header.textContent = 'These are DOM methods';
...
const domMethods = document.getElementsByClassName('dom-methods');
for (const element of domMethods) {
...
const mainEle = newDiv.getAttribute('id');
console.log(mainEle);
...
if (footerE !== null) {
  footerE.classList.remove('footer');
  footerE.classList.add('dom-method-footer');
}
